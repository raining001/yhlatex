...
# from onmt.utils_tools.general import run, get_files, delete_file, init_dir
#
...
def get_max_shape(arrays):
    ...
    for d in range(ndim):
        # print('shapes', shapes)
        # print('ndim', ndim)
        # print('max', max(shapes, key=lambda x: x[d]))
...
def build_images(formulas, dir_images, quality=200, density=300, down_ratio=2,
                 buckets=None, n_threads=4):
