...
class DataGenerator(object):
    ...
    def __init__(self, path_formulas, dir_images, path_matching, bucket=False,
        ...
        """Initializes the DataGenerator
            DataGenerator(path_formulas=config.path_formulas_train,
        ...
        Args:
            path_formulas: (string) file of formulas,. 训练集 latex公式文本
    ...
    def _process_instance(self, example):
        ...
        # print('raw_formula', self._get_raw_formula(formula_id))
    ...
    def build(self, quality=200, density=300, down_ratio=2, buckets=None,
                n_threads=4):
