...
class GRUEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout, add,
        ...
        self.rnn = nn.GRU(src_size, int(src_size / self.num_directions),
        ...
        self.rnn2 = nn.GRU(src_size, outsize,
                           num_layers=num_layers,
                           dropout=dropout,
                           bidirectional=bidirectional)
    ...
    def forward(self, src, lengths=None):
        ...
        out, hidden_t = self.rowcol(src)
        # out, hidden_t = self.rowcol_2(src)
        # out, hidden_t = self.res_row(src)
    ...
    def rowcol_3(self, src):
        ...
        print('row_out', row_out.size())
        print('col_out', col_out.size())
        return (row_out, col_out), (hidden_t, hidden_t2)
