...
class ImageEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, bidirectional, rnn_size, dropout,
        ...
        # self.rnn2 = nn.LSTM(src_size, int(rnn_size / self.num_directions),
        #                    num_layers=num_layers,
        #                    dropout=dropout,
        #                    bidirectional=bidirectional)
    ...
    def rowcol(self, src, cat=1):
        ...
        for row in range(src.size(2)):
            ...
            outputs, hidden_t = self.rnn(inp)
            all_outputs.append(outputs)
            # print('all_outputs', all_outputs[row].size())
        ...
        if cat == 1:
            ...
            out = out + out_col
            # h = hidden_t[0] + hidden_t2[0]
            # c = hidden_t[1] + hidden_t2[1]
            # hidden_t = (h, c)

        # print('all_outputs', len(all_outputs))
        # print('col_outputs', len(col_outputs))
